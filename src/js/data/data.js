...
module.exports = [
  ...
  },
  {
    ...
    imageUrl: "../../img/fps.jpg"
  },
  {
    title: '前端工作流',
    link: "https://github.com/yursile/",
    excerpt: '熟悉各种前端打包工具,grunt，gulp，webpack，并开发多个setup template。托管在个人github上，熟悉less，sass预编译。',
    imageUrl: "../../img/webpack.jpg"
  },
  {
    title: '前端类库',
  ...
  },
  {
    title: '其他',
    link: "https://github.com/yursile/",
    excerpt: '熟悉http协议，熟悉vscode，sublime，myeclipse,以及与设计配合PS，AI，FL，AN等工具开发H5，良好英文文档阅读能力，较强的学习能力，学习速度快，有坚韧的毅力。并且敢用1星插件。',
    imageUrl: "../../img/tools.jpg"
  },
  {
    title: 'createjs',
    link: "http://m.sohu.com/c/20252/",
    excerpt: '这是新闻中心神吐嘈的年终策划，采用createjs渲染canvas，snap操作SVG，与设计共同研究出一套制作动画H5的方案，利用AI制作SVG，FL转化为createjs代码，再操作转换后的createjs的lib',
  ...
  },
  {
    ...
    excerpt: '这是今年的时尚盛典预热专题页，有pc和移动两端。采用react编写，自此react已有几个项目经验。',
